...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/book/create").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/book/update").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/book/delete/{id}").authenticated()

                .antMatchers(HttpMethod.POST, "/api/order/create").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/order/update").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/order/delete-by-id/{id}").authenticated()

                .antMatchers(HttpMethod.POST, "/api/book-orders/create").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/book-orders/update").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/book-orders/delete-by-id/{id}").authenticated()
                .antMatchers(HttpMethod.GET, "/api/order/{id}").authenticated()
                .antMatchers(HttpMethod.GET, "/api/get-by-id/{id}").authenticated()
                .antMatchers(HttpMethod.GET, "/api/get-all").authenticated()

                .antMatchers(HttpMethod.POST, "/api/delivery/create").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/delivery/update").authenticated()
                .antMatchers(HttpMethod.GET, "/api/delivery/get-by-id/{id}").authenticated()
                .antMatchers(HttpMethod.GET, "/api/delivery/get-all").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/delivery/delete-by-id/{id}").authenticated()


                .antMatchers(HttpMethod.POST, "/api/book-image/create/{bookId}").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/book-image/update/{id}").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/book-image/delete/{id}").authenticated()
